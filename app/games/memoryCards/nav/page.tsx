                      ...
                      <div className="flex mx-auto justify-center items-center">
                          <div className="w-[600px] h-full flex flex-row items-center justify-between md:mr-20">
                                              <div className="flex items-center justify-between w-full h-auto border border-[#7042f861] bg-[#0300145e] mr-[15px] px-[20px] py-[10px] rounded-full text-gray-200">
                                                ...
                                                <Link href="/" className=" cursor-pointer mx-auto ml-3 px-2 text-xl">
                                                  Home
                                                </Link>

                                                <Link href="#skills" className="cursor-pointer mx-auto ml-2 p-1 text-xl">
                                                Cooperation
                                                </Link>
                                                <Link href="/menu/entertainment" className="cursor-pointer mx-auto ml-1 p-1 text-xl animate-in">
                                                 Games
                                                </Link>
                                                <Link href="#projects" className=" cursor-pointer mx-auto ml-3 px-2 text-xl">
                                                  Events
                                                </Link>
                                              </div>
